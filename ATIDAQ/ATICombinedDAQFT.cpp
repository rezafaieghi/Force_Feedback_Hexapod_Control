...
#define FIRST_TORQUE_INDEX 3 /*the index of the first torque reading in the standard output list order (fx, fy, fz, tx, ty, tz)*/
...
bool ATICombinedDAQFT::FTSystem::CheckForGaugeSaturation( double readings __gc[] )
{
